...
const Cakes = () => {
	const title = 'Tartas';
	const text =
		'Aquí encontrarás nuestras especialidades, con diversos rellenos como nuestra famosa crema de maracuyá, o nuestros delicioso ganache de chocolate con nuestra confitura de frutos rojos.';
	const link = '/products';
